...
module.exports = class UsersExpendituretypeController extends AbstractController {
                ...
                .then((_expendituretype)=> {
                  return Promise.resolve(models.Expenditure.findAll({attributes: ['expenditureYear'],group: 'expenditureYear',order: 'expenditureYear DESC'}))
                    .then((_expenditureYear)=> {
                      return Promise.resolve(res.render('users/expenses',{EXPENDITURETYPE: _expendituretype, EXPENDITUREYEAR : _expenditureYear, EXPENSETYPE: ecrappConstants.EXPENSETYPE}))
                    })
                })
          }
  ...
  addExpenses(req, res){
    ...
    let expenseObj = {
      ...
      expensePay: req.body.expensePay,
      expenseDeducted: req.body.expenseDeducted,
